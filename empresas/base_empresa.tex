% Base de contatos carregada no preâmbulo: o registro da empresa é escolhido
% automaticamente pelo nome do arquivo do ofício em compilação.
\input{empresas/contatos_brasil.tex}
\selecionaContatoPeloArquivo
