...
A diversidade do corpo docente favorece o uso compartilhado dos laboratórios e amplia a capacidade do DEE para atuar de forma integrada em automação, instrumentação, eletrônica, sistemas embarcados, sensores inteligentes, inteligência artificial, aprendizado de máquina, telecomunicações, máquinas e acionamentos, qualidade da energia, proteção, subestações e sistemas elétricos.
